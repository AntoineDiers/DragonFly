...
dragonfly_msgs::msg::ActuatorCommands fallback_modes::closed_loop_orbit::tick(const dragonfly_msgs::msg::Attitude &attitude, const dragonfly_msgs::msg::Altitude &altitude, Pids &pids)
{
    float pitch_setpoint = pids.altitude.tick(ALTITUDE_SETPOINT_M, altitude.altitude_m);
