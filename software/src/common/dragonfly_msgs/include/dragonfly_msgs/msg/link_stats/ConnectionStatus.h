...
public:
    ...
    static constexpr uint32_t _BodySize = sizeof(bool) + sizeof(uint16_t) + sizeof(uint8_t) +  0;
    ...
    {
        internal::deserialiseField<bool>(connected, buffer);
    ...
    {
        internal::serialiseField<bool>(connected, buffer);
    ...
    void _print(uint32_t n_tabs = 0) const
    {
        ...
        std::cout << "{\n";
        internal::printField<bool>("connected", connected, n_tabs + 1);
